    ...
    internal static partial class JsonWriterHelper
    {
        ...
        internal static void ValidateNumber(ReadOnlySpan<byte> utf8FormattedNumber)
        {
            ...
            if (utf8FormattedNumber[i] == '-')
            {
                ...
                {
                    throw new ArgumentException("Required digit not found, end of data");
                }
            }
            ...
            {
                throw new ArgumentException("Expected end of digit not found");
            }

            if (utf8FormattedNumber.Length <= i)
            {
                throw new ArgumentException("Required digit not found");
            }
