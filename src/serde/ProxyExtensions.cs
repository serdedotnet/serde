...
public static class ArrayStringExtensions
{
    extension(string[])
    {
        public static IDeserialize<string[]> Deserialize =>
            ArrayProxy.De<string, StringProxy>.Instance;
    }
    extension(string[])
    {
        public static ISerialize<string[]> Serialize =>
...
public static class ListStringExtensions
{
    ...
    {
        public static IDeserialize<List<string>> Deserialize =>
            ListProxy.De<string, StringProxy>.Instance;
    }
    extension(List<string>)
    {
        public static ISerialize<List<string>> Serialize =>
...
public static class DictStringTExtensions
{
    extension<T>(Dictionary<string, T>)
        where T : IDeserializeProvider<T>
    {
        public static IDeserialize<Dictionary<string, T>> Deserialize =>
            DictProxy.De<string, T, StringProxy, T>.Instance;
    }
    extension<T>(Dictionary<string, T>)
        where T : ISerializeProvider<T>
    {
        public static ISerialize<Dictionary<string, T>> Serialize =>
            DictProxy.Ser<string, T, StringProxy, T>.Instance;
    }
}
...
public static class DictStringStringExtensions
{
    ...
    {
        public static IDeserialize<Dictionary<string, string?>> Deserialize =>
            DictProxy
                .De<string, string?, StringProxy, NullableRefProxy.De<string, StringProxy>>
                .Instance;
    }
    extension(Dictionary<string, string?>)
    {
        public static ISerialize<Dictionary<string, string>> Serialize =>
            DictProxy.Ser<string, string, StringProxy, StringProxy>.Instance;
    }
}
...
public static class DictStringIntExtensions
{
    ...
    {
        public static IDeserialize<Dictionary<string, int>> Deserialize =>
            DictProxy.De<string, int, StringProxy, I32Proxy>.Instance;
    }
    extension(Dictionary<string, int>)
    {
        public static ISerialize<Dictionary<string, int>> Serialize =>
...
public static class DictStringNullableStringExtensions
{
    ...
    {
        public static IDeserialize<Dictionary<string, string>> Deserialize =>
            DictProxy.De<string, string, StringProxy, StringProxy>.Instance;
    }
    extension(Dictionary<string, string?>)
    {
        public static ISerialize<Dictionary<string, string?>> Serialize =>
            DictProxy
                .Ser<string, string?, StringProxy, NullableRefProxy.Ser<string, StringProxy>>
                .Instance;
    }
}
