...
namespace Serde.Test
{
    partial class JsonDeserializeTests
    {
        partial record BasicDU
        {
            ...
            {
                static IDeserialize<Serde.Test.JsonDeserializeTests.BasicDU.A> IDeserializeProvider<Serde.Test.JsonDeserializeTests.BasicDU.A>.DeserializeInstance => _m_AProxyDeserializeProxy.Instance;

                sealed class _m_AProxyDeserializeProxy : Serde.IDeserialize<Serde.Test.JsonDeserializeTests.BasicDU.A>
                {
