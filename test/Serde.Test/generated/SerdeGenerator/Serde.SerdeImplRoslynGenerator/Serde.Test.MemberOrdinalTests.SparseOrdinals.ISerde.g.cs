...
partial class MemberOrdinalTests
{
    ...
    {
        sealed partial class _SerdeObj : global::Serde.ISerde<Serde.Test.MemberOrdinalTests.SparseOrdinals>
        {
            global::Serde.ISerdeInfo global::Serde.ISerdeInfoProvider.SerdeInfo => Serde.Test.MemberOrdinalTests.SparseOrdinals.s_serdeInfo;
            ...
            Serde.Test.MemberOrdinalTests.SparseOrdinals Serde.IDeserialize<Serde.Test.MemberOrdinalTests.SparseOrdinals>.Deserialize(IDeserializer deserializer)
            {
                int _l_b = default!;
                int _l_c = default!;
                int _l_a = default!;
                ...
                var newType = new Serde.Test.MemberOrdinalTests.SparseOrdinals() {
                    B = _l_b,
                    C = _l_c,
                    A = _l_a,
                };
