...
namespace Serde.Json.Test
{
    partial class InvalidJsonTests
    {
        ...
        {
            static IDeserialize<Serde.Json.Test.InvalidJsonTests.ClassWithInt> IDeserializeProvider<Serde.Json.Test.InvalidJsonTests.ClassWithInt>.DeserializeInstance => ClassWithIntDeserializeProxy.Instance;

            sealed class ClassWithIntDeserializeProxy : Serde.IDeserialize<Serde.Json.Test.InvalidJsonTests.ClassWithInt>
            {
