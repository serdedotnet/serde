...
partial class InvalidJsonTests
{
    ...
    {
        static IDeserialize<Serde.Json.Test.InvalidJsonTests.ClassWithDictionaryOfIntArray> IDeserializeProvider<Serde.Json.Test.InvalidJsonTests.ClassWithDictionaryOfIntArray>.DeserializeInstance
            => ClassWithDictionaryOfIntArrayDeserializeProxy.Instance;

        sealed partial class ClassWithDictionaryOfIntArrayDeserializeProxy :Serde.IDeserialize<Serde.Json.Test.InvalidJsonTests.ClassWithDictionaryOfIntArray>
        {
            Serde.Json.Test.InvalidJsonTests.ClassWithDictionaryOfIntArray Serde.IDeserialize<Serde.Json.Test.InvalidJsonTests.ClassWithDictionaryOfIntArray>.Deserialize(IDeserializer deserializer)
            {
                ...
                while ((_l_index_ = typeDeserialize.TryReadIndex(_l_serdeInfo, out _)) != IDeserializeType.EndOfType)
                {
                    ...
                    {
                        case 0:
                            _l_obj = typeDeserialize.ReadValue<System.Collections.Generic.Dictionary<string, int[]>, Serde.DictProxy.Deserialize<string, int[], global::Serde.StringProxy, Serde.ArrayProxy.Deserialize<int, global::Serde.I32Proxy>>>(_l_index_);
