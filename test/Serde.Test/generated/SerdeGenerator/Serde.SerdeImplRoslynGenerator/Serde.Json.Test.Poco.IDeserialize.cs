...
namespace Serde.Json.Test
{
    ...
    {
        static IDeserialize<Serde.Json.Test.Poco> IDeserializeProvider<Serde.Json.Test.Poco>.DeserializeInstance => PocoDeserializeProxy.Instance;

        sealed class PocoDeserializeProxy : Serde.IDeserialize<Serde.Json.Test.Poco>
        {
