...
namespace Serde.Test
{
    partial class SerdeInfoTests
    {
        ...
        {
            static IDeserialize<Serde.Test.SerdeInfoTests.Rgb> IDeserializeProvider<Serde.Test.SerdeInfoTests.Rgb>.DeserializeInstance => RgbProxyDeserializeProxy.Instance;

            sealed class RgbProxyDeserializeProxy : Serde.IDeserialize<Serde.Test.SerdeInfoTests.Rgb>
            {
