...
partial class MemberOrdinalTests
{
    ...
    {
        sealed partial class _SerdeObj : global::Serde.ISerde<Serde.Test.MemberOrdinalTests.NoOrdinals>
        {
            global::Serde.ISerdeInfo global::Serde.ISerdeInfoProvider.SerdeInfo => Serde.Test.MemberOrdinalTests.NoOrdinals.s_serdeInfo;
            ...
            Serde.Test.MemberOrdinalTests.NoOrdinals Serde.IDeserialize<Serde.Test.MemberOrdinalTests.NoOrdinals>.Deserialize(IDeserializer deserializer)
            {
                int _l_a = default!;
                int _l_b = default!;
                ...
                var newType = new Serde.Test.MemberOrdinalTests.NoOrdinals() {
                    A = _l_a,
                    B = _l_b,
                };
