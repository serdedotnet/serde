...
partial class MemberOrdinalTests
{
    ...
    {
        sealed partial class _SerdeObj : global::Serde.ISerde<Serde.Test.MemberOrdinalTests.FullyOrdered>
        {
            global::Serde.ISerdeInfo global::Serde.ISerdeInfoProvider.SerdeInfo => Serde.Test.MemberOrdinalTests.FullyOrdered.s_serdeInfo;
            ...
            void global::Serde.ISerialize<Serde.Test.MemberOrdinalTests.FullyOrdered>.Serialize(Serde.Test.MemberOrdinalTests.FullyOrdered value, global::Serde.ISerializer serializer)
            {
                ...
                _l_type.WriteI32(_l_info, 3, value.A);
                _l_type.End(_l_info);
            }
            Serde.Test.MemberOrdinalTests.FullyOrdered Serde.IDeserialize<Serde.Test.MemberOrdinalTests.FullyOrdered>.Deserialize(IDeserializer deserializer)
            {
                int _l_b = default!;
                int _l_d = default!;
                int _l_c = default!;
                ...
                while (true)
                {
                    ...
                    switch (_l_index_)
                    {
                        ...
                        case 1:
                            ...
                            _l_d = typeDeserialize.ReadI32(_l_serdeInfo, _l_index_);
