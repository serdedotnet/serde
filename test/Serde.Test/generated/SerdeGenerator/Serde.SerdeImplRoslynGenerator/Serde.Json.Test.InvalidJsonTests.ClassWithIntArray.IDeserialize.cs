...
namespace Serde.Json.Test
{
    partial class InvalidJsonTests
    {
        ...
        {
            static IDeserialize<Serde.Json.Test.InvalidJsonTests.ClassWithIntArray> IDeserializeProvider<Serde.Json.Test.InvalidJsonTests.ClassWithIntArray>.DeserializeInstance => ClassWithIntArrayDeserializeProxy.Instance;

            sealed class ClassWithIntArrayDeserializeProxy : Serde.IDeserialize<Serde.Json.Test.InvalidJsonTests.ClassWithIntArray>
            {
                Serde.Json.Test.InvalidJsonTests.ClassWithIntArray Serde.IDeserialize<Serde.Json.Test.InvalidJsonTests.ClassWithIntArray>.Deserialize(IDeserializer deserializer)
                {
                    ...
                    while ((_l_index_ = typeDeserialize.TryReadIndex(_l_serdeInfo, out _)) != IDeserializeType.EndOfType)
                    {
                        ...
                        {
                            case 0:
                                _l_obj = typeDeserialize.ReadValue<int[], Serde.ArrayProxy.Deserialize<int, global::Serde.Int32Proxy>>(_l_index_);
