...
namespace Serde.Test
{
    partial class JsonDeserializeTests
    {
        ...
        {
            static IDeserialize<Serde.Test.JsonDeserializeTests.BasicDU> IDeserializeProvider<Serde.Test.JsonDeserializeTests.BasicDU>.DeserializeInstance => BasicDUDeserializeProxy.Instance;

            sealed class BasicDUDeserializeProxy : Serde.IDeserialize<Serde.Test.JsonDeserializeTests.BasicDU>
            {
