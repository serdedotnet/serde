...
namespace Serde.Test
{
    partial class JsonSerializerTests
    {
        ...
        {
            static ISerialize<Serde.Test.JsonSerializerTests.BasicDU> ISerializeProvider<Serde.Test.JsonSerializerTests.BasicDU>.SerializeInstance => BasicDUSerializeProxy.Instance;

            sealed class BasicDUSerializeProxy : Serde.ISerialize<Serde.Test.JsonSerializerTests.BasicDU>
            {
                void ISerialize<Serde.Test.JsonSerializerTests.BasicDU>.Serialize(Serde.Test.JsonSerializerTests.BasicDU value, ISerializer serializer)
                {
                    ...
                    switch (value)
                    {
                        case Serde.Test.JsonSerializerTests.BasicDU.A c:
                            _l_type.SerializeField<Serde.Test.JsonSerializerTests.BasicDU.A, _m_AProxy>(_l_serdeInfo, 0, c);
                            break;
                        case Serde.Test.JsonSerializerTests.BasicDU.B c:
                            _l_type.SerializeField<Serde.Test.JsonSerializerTests.BasicDU.B, _m_BProxy>(_l_serdeInfo, 1, c);
                            break;
                    }
