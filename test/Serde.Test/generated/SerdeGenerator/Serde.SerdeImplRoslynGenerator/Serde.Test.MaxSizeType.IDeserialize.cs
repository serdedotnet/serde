...
namespace Serde.Test
{
    ...
    {
        static IDeserialize<Serde.Test.MaxSizeType> IDeserializeProvider<Serde.Test.MaxSizeType>.DeserializeInstance => MaxSizeTypeDeserializeProxy.Instance;

        sealed class MaxSizeTypeDeserializeProxy : Serde.IDeserialize<Serde.Test.MaxSizeType>
        {
