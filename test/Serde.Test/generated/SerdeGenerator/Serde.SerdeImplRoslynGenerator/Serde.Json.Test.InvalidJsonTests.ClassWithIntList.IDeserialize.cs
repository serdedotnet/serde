...
partial class InvalidJsonTests
{
    ...
    {
        static IDeserialize<Serde.Json.Test.InvalidJsonTests.ClassWithIntList> IDeserializeProvider<Serde.Json.Test.InvalidJsonTests.ClassWithIntList>.DeserializeInstance
            => ClassWithIntListDeserializeProxy.Instance;

        sealed partial class ClassWithIntListDeserializeProxy :Serde.IDeserialize<Serde.Json.Test.InvalidJsonTests.ClassWithIntList>
        {
            ...
            public static readonly ClassWithIntListDeserializeProxy Instance = new();
            private ClassWithIntListDeserializeProxy() { }
