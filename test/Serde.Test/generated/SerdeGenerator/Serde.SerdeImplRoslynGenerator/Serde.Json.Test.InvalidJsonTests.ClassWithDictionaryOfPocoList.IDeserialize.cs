...
namespace Serde.Json.Test
{
    partial class InvalidJsonTests
    {
        ...
        {
            static IDeserialize<Serde.Json.Test.InvalidJsonTests.ClassWithDictionaryOfPocoList> IDeserializeProvider<Serde.Json.Test.InvalidJsonTests.ClassWithDictionaryOfPocoList>.DeserializeInstance => ClassWithDictionaryOfPocoListDeserializeProxy.Instance;

            sealed class ClassWithDictionaryOfPocoListDeserializeProxy : Serde.IDeserialize<Serde.Json.Test.InvalidJsonTests.ClassWithDictionaryOfPocoList>
            {
