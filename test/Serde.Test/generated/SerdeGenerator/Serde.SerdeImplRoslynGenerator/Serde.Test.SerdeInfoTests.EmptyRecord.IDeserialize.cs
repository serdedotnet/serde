...
namespace Serde.Test
{
    partial class SerdeInfoTests
    {
        ...
        {
            static IDeserialize<Serde.Test.SerdeInfoTests.EmptyRecord> IDeserializeProvider<Serde.Test.SerdeInfoTests.EmptyRecord>.DeserializeInstance => EmptyRecordDeserializeProxy.Instance;

            sealed class EmptyRecordDeserializeProxy : Serde.IDeserialize<Serde.Test.SerdeInfoTests.EmptyRecord>
            {
