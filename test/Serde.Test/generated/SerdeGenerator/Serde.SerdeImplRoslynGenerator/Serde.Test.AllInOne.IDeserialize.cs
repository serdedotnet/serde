...
namespace Serde.Test
{
    ...
    {
        static IDeserialize<Serde.Test.AllInOne> IDeserializeProvider<Serde.Test.AllInOne>.DeserializeInstance => AllInOneDeserializeProxy.Instance;

        sealed class AllInOneDeserializeProxy : Serde.IDeserialize<Serde.Test.AllInOne>
        {
