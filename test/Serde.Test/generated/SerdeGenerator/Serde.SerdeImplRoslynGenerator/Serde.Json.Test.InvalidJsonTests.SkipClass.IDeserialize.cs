...
namespace Serde.Json.Test
{
    partial class InvalidJsonTests
    {
        ...
        {
            static IDeserialize<Serde.Json.Test.InvalidJsonTests.SkipClass> IDeserializeProvider<Serde.Json.Test.InvalidJsonTests.SkipClass>.DeserializeInstance => SkipClassDeserializeProxy.Instance;

            sealed class SkipClassDeserializeProxy : Serde.IDeserialize<Serde.Json.Test.InvalidJsonTests.SkipClass>
            {
