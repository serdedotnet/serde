...
namespace Serde.Test
{
    partial class JsonDeserializeTests
    {
        ...
        {
            static IDeserialize<Serde.Test.JsonDeserializeTests.SetToNull> IDeserializeProvider<Serde.Test.JsonDeserializeTests.SetToNull>.DeserializeInstance => SetToNullDeserializeProxy.Instance;

            sealed class SetToNullDeserializeProxy : Serde.IDeserialize<Serde.Test.JsonDeserializeTests.SetToNull>
            {
