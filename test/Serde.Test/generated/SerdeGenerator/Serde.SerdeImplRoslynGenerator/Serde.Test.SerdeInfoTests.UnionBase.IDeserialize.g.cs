        ...
        sealed partial class _DeObj : Serde.IDeserialize<Serde.Test.SerdeInfoTests.UnionBase>
        {
            ...
            async global::System.Threading.Tasks.ValueTask<Serde.Test.SerdeInfoTests.UnionBase> IDeserialize<Serde.Test.SerdeInfoTests.UnionBase>.Deserialize(IDeserializer deserializer)
            {
                ...
                Serde.Test.SerdeInfoTests.UnionBase _l_result = index switch {
                    0 => await de.ReadValue<Serde.Test.SerdeInfoTests.UnionBase.A, _m_AProxy>(_l_serdeInfo, 0),
                    1 => await de.ReadValue<Serde.Test.SerdeInfoTests.UnionBase.B, _m_BProxy>(_l_serdeInfo, 1),
