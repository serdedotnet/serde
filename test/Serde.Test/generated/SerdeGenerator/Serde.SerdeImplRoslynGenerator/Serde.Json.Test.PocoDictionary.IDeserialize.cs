...
{
    static IDeserialize<Serde.Json.Test.PocoDictionary> IDeserializeProvider<Serde.Json.Test.PocoDictionary>.DeserializeInstance
        => PocoDictionaryDeserializeProxy.Instance;

    sealed partial class PocoDictionaryDeserializeProxy :Serde.IDeserialize<Serde.Json.Test.PocoDictionary>
    {
