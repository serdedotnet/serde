...
namespace Serde.Test
{
    partial class JsonDeserializeTests
    {
        ...
        {
            static IDeserialize<Serde.Test.JsonDeserializeTests.DenyUnknown> IDeserializeProvider<Serde.Test.JsonDeserializeTests.DenyUnknown>.DeserializeInstance => DenyUnknownDeserializeProxy.Instance;

            sealed class DenyUnknownDeserializeProxy : Serde.IDeserialize<Serde.Test.JsonDeserializeTests.DenyUnknown>
            {
