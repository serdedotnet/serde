...
namespace Serde.Test
{
    partial class JsonDeserializeTests
    {
        ...
        {
            static IDeserialize<Serde.Test.JsonDeserializeTests.SkipDeserialize> IDeserializeProvider<Serde.Test.JsonDeserializeTests.SkipDeserialize>.DeserializeInstance => SkipDeserializeDeserializeProxy.Instance;

            sealed class SkipDeserializeDeserializeProxy : Serde.IDeserialize<Serde.Test.JsonDeserializeTests.SkipDeserialize>
            {
