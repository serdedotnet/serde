...
namespace Serde.Json.Test
{
    partial class InvalidJsonTests
    {
        ...
        {
            static IDeserialize<Serde.Json.Test.InvalidJsonTests.ClassWithPoco> IDeserializeProvider<Serde.Json.Test.InvalidJsonTests.ClassWithPoco>.DeserializeInstance => ClassWithPocoDeserializeProxy.Instance;

            sealed class ClassWithPocoDeserializeProxy : Serde.IDeserialize<Serde.Json.Test.InvalidJsonTests.ClassWithPoco>
            {
