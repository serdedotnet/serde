...
namespace Serde.Json.Test
{
    partial class InvalidJsonTests
    {
        ...
        {
            static IDeserialize<Serde.Json.Test.InvalidJsonTests.ClassWithDictionaryOfPoco> IDeserializeProvider<Serde.Json.Test.InvalidJsonTests.ClassWithDictionaryOfPoco>.DeserializeInstance => ClassWithDictionaryOfPocoDeserializeProxy.Instance;

            sealed class ClassWithDictionaryOfPocoDeserializeProxy : Serde.IDeserialize<Serde.Json.Test.InvalidJsonTests.ClassWithDictionaryOfPoco>
            {
