...
namespace Serde.Test
{
    partial class SampleTest
    {
        ...
        {
            static ISerialize<Serde.Test.SampleTest.Address> ISerializeProvider<Serde.Test.SampleTest.Address>.SerializeInstance => AddressSerializeProxy.Instance;

            sealed class AddressSerializeProxy : Serde.ISerialize<Serde.Test.SampleTest.Address>
            {
