...
namespace Serde.Test
{
    partial class XmlTests
    {
        ...
        {
            static ISerialize<Serde.Test.XmlTests.BoolStruct> ISerializeProvider<Serde.Test.XmlTests.BoolStruct>.SerializeInstance => BoolStructSerializeProxy.Instance;

            sealed class BoolStructSerializeProxy : Serde.ISerialize<Serde.Test.XmlTests.BoolStruct>
            {
