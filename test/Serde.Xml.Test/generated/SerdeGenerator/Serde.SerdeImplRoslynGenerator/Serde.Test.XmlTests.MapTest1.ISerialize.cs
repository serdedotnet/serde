...
namespace Serde.Test
{
    partial class XmlTests
    {
        ...
        {
            static ISerialize<Serde.Test.XmlTests.MapTest1> ISerializeProvider<Serde.Test.XmlTests.MapTest1>.SerializeInstance => MapTest1SerializeProxy.Instance;

            sealed class MapTest1SerializeProxy : Serde.ISerialize<Serde.Test.XmlTests.MapTest1>
            {
