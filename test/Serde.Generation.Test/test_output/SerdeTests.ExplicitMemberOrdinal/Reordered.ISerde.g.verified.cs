//HintName: Reordered.ISerde.g.cs
...
{
    sealed partial class _SerdeObj : global::Serde.ISerde<Reordered>
    {
        global::Serde.ISerdeInfo global::Serde.ISerdeInfoProvider.SerdeInfo => Reordered.s_serdeInfo;
        ...
        Reordered Serde.IDeserialize<Reordered>.Deserialize(IDeserializer deserializer)
        {
            int _l_b = default!;
            int _l_c = default!;
            int _l_a = default!;
