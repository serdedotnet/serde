...
namespace Some.Nested.Namespace
{
    ...
    {
        static IDeserialize<Some.Nested.Namespace.Base> IDeserializeProvider<Some.Nested.Namespace.Base>.DeserializeInstance => BaseDeserializeProxy.Instance;

        sealed class BaseDeserializeProxy : Serde.IDeserialize<Some.Nested.Namespace.Base>
        {
