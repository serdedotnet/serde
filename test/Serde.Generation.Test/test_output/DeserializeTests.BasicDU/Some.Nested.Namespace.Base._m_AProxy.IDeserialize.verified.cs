...
namespace Some.Nested.Namespace
{
    partial record Base
    {
        ...
        {
            static IDeserialize<Some.Nested.Namespace.Base.A> IDeserializeProvider<Some.Nested.Namespace.Base.A>.DeserializeInstance => _m_AProxyDeserializeProxy.Instance;

            sealed class _m_AProxyDeserializeProxy : Serde.IDeserialize<Some.Nested.Namespace.Base.A>
            {
