...
partial record AllInOne : Serde.ISerializeProvider<Serde.Test.AllInOne>
{
    ...
    sealed partial class _SerObj :Serde.ISerialize<Serde.Test.AllInOne>
    {
        ...
        void global::Serde.ISerialize<Serde.Test.AllInOne>.Serialize(Serde.Test.AllInOne value, global::Serde.ISerializer serializer)
        {
            ...
            _l_type.WriteString(_l_info, 12, value.EscapedStringField);
            _l_type.WriteStringIfNotNull(_l_info, 13, value.NullStringField);
            _l_type.WriteValue<uint[], Serde.ArrayProxy.Ser<uint, global::Serde.U32Proxy>>(_l_info, 14, value.UIntArr);
            _l_type.WriteValue<int[][], Serde.ArrayProxy.Ser<int[], Serde.ArrayProxy.Ser<int, global::Serde.I32Proxy>>>(_l_info, 15, value.NestedArr);
            _l_type.WriteBoxedValue<System.Collections.Immutable.ImmutableArray<int>, Serde.ImmutableArrayProxy.Ser<int, global::Serde.I32Proxy>>(_l_info, 16, value.IntImm);
            _l_type.WriteBoxedValue<Serde.Test.AllInOne.ColorEnum, Serde.Test.AllInOne.ColorEnumProxy>(_l_info, 17, value.Color);
            _l_type.End(_l_info);
        }
