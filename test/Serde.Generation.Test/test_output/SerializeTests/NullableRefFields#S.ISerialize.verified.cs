...
{
    static ISerialize<S<T1, T2, T3, T4, T5>> ISerializeProvider<S<T1, T2, T3, T4, T5>>.SerializeInstance => SSerializeProxy.Instance;

    sealed class SSerializeProxy : Serde.ISerialize<S<T1, T2, T3, T4, T5>>
    {
