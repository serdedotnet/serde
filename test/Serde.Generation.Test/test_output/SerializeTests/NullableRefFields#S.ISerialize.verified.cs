...
partial struct S<T1, T2, T3, T4, T5> : Serde.ISerialize<S<T1, T2, T3, T4, T5>>
{
    void ISerialize<S<T1, T2, T3, T4, T5>>.Serialize(S<T1, T2, T3, T4, T5> value, ISerializer serializer)
    {
        ...
        type.SerializeFieldIfNotNull<string?, Serde.NullableRefWrap.SerializeImpl<string, StringWrap>>(_l_serdeInfo, 0, value.FS);
        ...
        type.SerializeFieldIfNotNull<T3?, Serde.NullableRefWrap.SerializeImpl<T3, IdWrap<T3>>>(_l_serdeInfo, 3, value.F3);
