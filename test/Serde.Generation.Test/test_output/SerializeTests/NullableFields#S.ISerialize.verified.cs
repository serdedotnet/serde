...
{
    static ISerialize<S<T1, T2, TSerialize>> ISerializeProvider<S<T1, T2, TSerialize>>.SerializeInstance => SSerializeProxy.Instance;

    sealed class SSerializeProxy : Serde.ISerialize<S<T1, T2, TSerialize>>
    {
