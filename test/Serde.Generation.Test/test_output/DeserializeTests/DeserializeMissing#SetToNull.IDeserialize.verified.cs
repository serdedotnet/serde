...
{
    static IDeserialize<SetToNull> IDeserializeProvider<SetToNull>.DeserializeInstance => SetToNullDeserializeProxy.Instance;

    sealed class SetToNullDeserializeProxy : Serde.IDeserialize<SetToNull>
    {
        SetToNull Serde.IDeserialize<SetToNull>.Deserialize(IDeserializer deserializer)
        {
            ...
            while ((_l_index_ = typeDeserialize.TryReadIndex(_l_serdeInfo, out _)) != IDeserializeType.EndOfType)
            {
                switch (_l_index_)
                {
                    ...
                    case 1:
                        ...
                        break;
                    case 2:
                        _l_throwmissing = typeDeserialize.ReadValue<string?, Serde.NullableRefProxy.Deserialize<string, global::Serde.StringProxy>>(_l_index_);
