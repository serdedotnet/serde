...
{
    static IDeserialize<SetToNull> IDeserializeProvider<SetToNull>.DeserializeInstance
        => SetToNullDeserializeProxy.Instance;

    sealed partial class SetToNullDeserializeProxy :Serde.IDeserialize<SetToNull>
    {
