...
{
    static IDeserialize<ArrayField> IDeserializeProvider<ArrayField>.DeserializeInstance => ArrayFieldDeserializeProxy.Instance;

    sealed class ArrayFieldDeserializeProxy : Serde.IDeserialize<ArrayField>
    {
