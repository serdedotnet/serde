...
partial class TestCase15
{
    ...
    {
        static ISerialize<TestCase15.Class1> ISerializeProvider<TestCase15.Class1>.SerializeInstance => Class1SerializeProxy.Instance;

        sealed class Class1SerializeProxy : Serde.ISerialize<TestCase15.Class1>
        {
