...
partial class TestCase15
{
    partial class Class0 : Serde.ISerialize<TestCase15.Class0>
    {
        void ISerialize<TestCase15.Class0>.Serialize(TestCase15.Class0 value, ISerializer serializer)
        {
            ...
            type.SerializeField<TestCase15.Class1[], Serde.ArrayWrap.SerializeImpl<TestCase15.Class1, IdWrap<TestCase15.Class1>>>(_l_typeInfo, 0, this.Field0);
            type.SerializeField<bool[], Serde.ArrayWrap.SerializeImpl<bool, BoolWrap>>(_l_typeInfo, 1, this.Field1);
            type.End();
        }
    }
}