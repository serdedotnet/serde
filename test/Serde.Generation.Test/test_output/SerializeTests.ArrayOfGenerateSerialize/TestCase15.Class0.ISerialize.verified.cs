...
partial class TestCase15
{
    ...
    {
        static ISerialize<TestCase15.Class0> ISerializeProvider<TestCase15.Class0>.SerializeInstance => Class0SerializeProxy.Instance;

        sealed class Class0SerializeProxy : Serde.ISerialize<TestCase15.Class0>
        {
