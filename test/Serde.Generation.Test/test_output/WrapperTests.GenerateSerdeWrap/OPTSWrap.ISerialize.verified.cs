...
{
    static ISerialize<System.Runtime.InteropServices.ComTypes.BIND_OPTS> ISerializeProvider<System.Runtime.InteropServices.ComTypes.BIND_OPTS>.SerializeInstance => OPTSWrapSerializeProxy.Instance;

    sealed class OPTSWrapSerializeProxy : Serde.ISerialize<System.Runtime.InteropServices.ComTypes.BIND_OPTS>
    {
