...
{
    static ISerialize<Address> ISerializeProvider<Address>.SerializeInstance => AddressSerializeProxy.Instance;

    sealed class AddressSerializeProxy : Serde.ISerialize<Address>
    {
