...
{
    static IDeserialize<Test.Parent> IDeserializeProvider<Test.Parent>.DeserializeInstance
        => ParentDeserializeProxy.Instance;

    sealed partial class ParentDeserializeProxy :Serde.IDeserialize<Test.Parent>
    {
        ...
        public static readonly ParentDeserializeProxy Instance = new();
        private ParentDeserializeProxy() { }
