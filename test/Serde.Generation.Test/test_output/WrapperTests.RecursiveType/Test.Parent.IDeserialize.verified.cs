...
namespace Test
{
    ...
    {
        static IDeserialize<Test.Parent> IDeserializeProvider<Test.Parent>.DeserializeInstance => ParentDeserializeProxy.Instance;

        sealed class ParentDeserializeProxy : Serde.IDeserialize<Test.Parent>
        {
