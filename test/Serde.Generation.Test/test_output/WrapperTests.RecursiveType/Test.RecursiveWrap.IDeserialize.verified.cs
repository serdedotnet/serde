...
namespace Test
{
    ...
    {
        static IDeserialize<Recursive> IDeserializeProvider<Recursive>.DeserializeInstance => RecursiveWrapDeserializeProxy.Instance;

        sealed class RecursiveWrapDeserializeProxy : Serde.IDeserialize<Recursive>
        {
