...
{
    static IDeserialize<System.Runtime.InteropServices.ComTypes.BIND_OPTS> IDeserializeProvider<System.Runtime.InteropServices.ComTypes.BIND_OPTS>.DeserializeInstance => OptsWrapDeserializeProxy.Instance;

    sealed class OptsWrapDeserializeProxy : Serde.IDeserialize<System.Runtime.InteropServices.ComTypes.BIND_OPTS>
    {
        ...
        public static readonly OptsWrapDeserializeProxy Instance = new();
        private OptsWrapDeserializeProxy()
        {
        }
    }
}