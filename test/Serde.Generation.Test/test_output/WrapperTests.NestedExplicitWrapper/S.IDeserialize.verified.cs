    ...
    private sealed class SerdeVisitor : Serde.IDeserializeVisitor<S>
    {
        ...
        S Serde.IDeserializeVisitor<S>.VisitDictionary<D>(ref D d)
        {
            ...
            while (d.TryGetNextKey<byte, FieldNameVisitor>(out byte key))
            {
                ...
                {
                    case 1:
                        _l_sections = d.GetNextValue<System.Collections.Immutable.ImmutableArray<System.Collections.Specialized.BitVector32.Section>, Serde.ImmutableArrayWrap.DeserializeImpl<System.Collections.Specialized.BitVector32.Section, Outer.SectionWrap>>();
