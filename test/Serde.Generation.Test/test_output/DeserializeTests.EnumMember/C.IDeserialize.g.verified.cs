            ...
            while (true)
            {
                ...
                switch (_l_index_)
                {
                    case 0:
                        ...
                        _l_colorint = typeDeserialize.ReadValue<ColorInt, ColorIntProxy>(_l_serdeInfo, _l_index_);
                        _r_assignedValid |= ((byte)1) << 0;
                        break;
                    case 1:
                        Serde.DeserializeException.ThrowIfDuplicate(_r_assignedValid, 1, _l_serdeInfo);
                        _l_colorbyte = typeDeserialize.ReadValue<ColorByte, ColorByteProxy>(_l_serdeInfo, _l_index_);
                        _r_assignedValid |= ((byte)1) << 1;
                        break;
                    case 2:
                        Serde.DeserializeException.ThrowIfDuplicate(_r_assignedValid, 2, _l_serdeInfo);
                        _l_colorlong = typeDeserialize.ReadValue<ColorLong, ColorLongProxy>(_l_serdeInfo, _l_index_);
                        _r_assignedValid |= ((byte)1) << 2;
                        break;
                    case 3:
                        Serde.DeserializeException.ThrowIfDuplicate(_r_assignedValid, 3, _l_serdeInfo);
                        _l_colorulong = typeDeserialize.ReadValue<ColorULong, ColorULongProxy>(_l_serdeInfo, _l_index_);
