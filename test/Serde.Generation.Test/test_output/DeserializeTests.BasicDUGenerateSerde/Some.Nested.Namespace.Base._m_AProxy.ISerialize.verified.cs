...
namespace Some.Nested.Namespace
{
    partial record Base
    {
        ...
        {
            static ISerialize<Some.Nested.Namespace.Base.A> ISerializeProvider<Some.Nested.Namespace.Base.A>.SerializeInstance => _m_AProxySerializeProxy.Instance;

            sealed class _m_AProxySerializeProxy : Serde.ISerialize<Some.Nested.Namespace.Base.A>
            {
                void ISerialize<Some.Nested.Namespace.Base.A>.Serialize(Some.Nested.Namespace.Base.A value, ISerializer serializer)
                {
