...
namespace Some.Nested.Namespace
{
    partial record Base
    {
        ...
        {
            static ISerialize<Some.Nested.Namespace.Base.B> ISerializeProvider<Some.Nested.Namespace.Base.B>.SerializeInstance => _m_BProxySerializeProxy.Instance;

            sealed class _m_BProxySerializeProxy : Serde.ISerialize<Some.Nested.Namespace.Base.B>
            {
                void ISerialize<Some.Nested.Namespace.Base.B>.Serialize(Some.Nested.Namespace.Base.B value, ISerializer serializer)
                {
